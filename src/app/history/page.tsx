...
export default function HistoryPage() {
  return <main className="flex-1"><LocalizedPageIntro eyebrow="history.eyebrow" title="history.title" description="history.description" width="max-w-6xl" /><HistoryList /></main>;
}